...
// Package types contains all user-defined data types used in Insights Operator
// CLI client. Some types that are the same as in other services (especially in

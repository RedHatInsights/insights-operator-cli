...
func PrintHelp() {
	...
	fmt.Println(aurora.Yellow("enable ##                "), "enable cluster configuration selected by its ID")
	fmt.Println(aurora.Yellow("disable ##               "), "disable cluster configuration selected by its ID")
